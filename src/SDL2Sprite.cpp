...
EssexEngine::Drivers::SDL2::SDL2Sprite::SDL2Sprite(CachedPointer<std::string, Daemons::FileSystem::IFileBuffer> _fileBuffer, SDL_Texture* _texture, int _x, int _y, int _width, int _height)
